...
function brw_gf_ready_class_selector_revised_render_editor_js(){
      $modal_html = "
              <div id='css_ready_modal'>
                <style>#css_ready_selector,a.cssr_acc_link,a.cssr_link{text-decoration:none}#css_ready_modal h4{margin-bottom:2px}.cssr_accordian{display:-ms-flexbox;display:-webkit-flex;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-content:space-between;-ms-flex-line-pack:justify;align-content:space-between;-webkit-align-items:center;-ms-flex-align:center;align-items:center;margin:5px 0}a.cssr_acc_link{font-weight:700;display:block;padding:5px;text-align:left;background:#888;border:1px solid #ddd;color:#fff}a.cssr_link{margin:2px;text-align:center;padding:3px;border:1px solid #aaa;background:#eee;display:inline-block;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;-webkit-order:0;-ms-flex-order:0;order:0;-webkit-flex:1 0 auto;-ms-flex:1 0 auto;flex:1 0 auto;-webkit-align-self:stretch;-ms-flex-item-align:stretch;align-self:stretch}a.cssr_link:hover{background:#ddd}ul.cssr_ul{margin:0;padding:0}ul.cssr_ul li{margin:2px;padding:0}</style>              
